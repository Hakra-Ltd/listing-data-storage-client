...
from listing_data_storage_client.models.ticketmaster_sold_response_schema import TicketmasterSoldResponseSchema
...
class PrimaryApi:
    ...
    @validate_call
    async def get_event_info_v0_primary_ticketmaster_event_id_info_post(
        self,
        event_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        Testing endpoint for the event info
        ...
        _param = self._get_event_info_v0_primary_ticketmaster_event_id_info_post_serialize(
            event_id=event_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_event_info_v0_primary_ticketmaster_event_id_info_post_with_http_info(
        self,
        event_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_event_info_v0_primary_ticketmaster_event_id_info_post_without_preload_content(
        self,
        event_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_event_info_v0_primary_ticketmaster_event_id_info_post_serialize(
        self,
        event_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v0/primary/ticketmaster/{eventId}/info',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_sold_tickets_v0_primary_ticketmaster_event_id_sold_get(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> TicketmasterSoldResponseSchema:
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /v0/primary/ticketmaster/{eventId}/sold is deprecated.", DeprecationWarning)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TicketmasterSoldResponseSchema",
            '422': "HTTPValidationError",
        }
        response_data = await self.api_client.call_api(
            *_param,
    ...
    async def get_sold_tickets_v0_primary_ticketmaster_event_id_sold_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TicketmasterSoldResponseSchema]:
        """(Deprecated) Get Sold Tickets
