...
from listing_data_storage_client.models.ticketmaster_available_detailed_with_update_plus_response_schema import TicketmasterAvailableDetailedWithUpdatePlusResponseSchema
...
class PrimaryApi:
    ...
    @validate_call
    async def get_available_detailed_with_update_plus_v0_primary_ticketmaster_event_id_available_detailed_update_plus_get(
        self,
        event_id: StrictStr,
        full_section: Annotated[Optional[StrictStr], Field(description="Full section for filtering")] = None,
        section: Annotated[Optional[StrictStr], Field(description="Section for filtering")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> TicketmasterAvailableDetailedWithUpdatePlusResponseSchema:
        """Get Available Detailed With Update Plus
        ...
        _param = self._get_available_detailed_with_update_plus_v0_primary_ticketmaster_event_id_available_detailed_update_plus_get_serialize(
            event_id=event_id,
            full_section=full_section,
            section=section,
            row=row,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TicketmasterAvailableDetailedWithUpdatePlusResponseSchema",
            '422': "HTTPValidationError",
        }
        response_data = await self.api_client.call_api(
            *_param,
    ...
    @validate_call
    async def get_available_detailed_with_update_plus_v0_primary_ticketmaster_event_id_available_detailed_update_plus_get_with_http_info(
        self,
        event_id: StrictStr,
        full_section: Annotated[Optional[StrictStr], Field(description="Full section for filtering")] = None,
        section: Annotated[Optional[StrictStr], Field(description="Section for filtering")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TicketmasterAvailableDetailedWithUpdatePlusResponseSchema]:
        """Get Available Detailed With Update Plus
    ...
    @validate_call
    async def get_available_detailed_with_update_plus_v0_primary_ticketmaster_event_id_available_detailed_update_plus_get_without_preload_content(
        self,
        event_id: StrictStr,
        full_section: Annotated[Optional[StrictStr], Field(description="Full section for filtering")] = None,
        section: Annotated[Optional[StrictStr], Field(description="Section for filtering")] = None,
    ...
    def _get_available_detailed_with_update_plus_v0_primary_ticketmaster_event_id_available_detailed_update_plus_get_serialize(
        self,
        event_id,
        full_section,
        section,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v0/primary/ticketmaster/{eventId}/available-detailed/update-plus',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
