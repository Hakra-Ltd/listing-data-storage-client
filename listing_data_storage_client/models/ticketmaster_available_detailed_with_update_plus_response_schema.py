...
from listing_data_storage_client.models.ticketmaster_available_ga_detailed_with_update_plus_ga_schema import TicketmasterAvailableGaDetailedWithUpdatePlusGaSchema
from typing import Optional, Set
from typing_extensions import Self

class TicketmasterAvailableDetailedWithUpdatePlusResponseSchema(BaseModel):
    """
    ...
    available_ga_places: Optional[List[TicketmasterAvailableGaDetailedWithUpdatePlusGaSchema]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TicketmasterAvailableDetailedWithUpdatePlusResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TicketmasterAvailableDetailedWithUpdatePlusResponseSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "available_ga_places": [TicketmasterAvailableGaDetailedWithUpdatePlusGaSchema.from_dict(_item) for _item in obj["available_ga_places"]] if obj.get("available_ga_places") is not None else None
        })
        return _obj
