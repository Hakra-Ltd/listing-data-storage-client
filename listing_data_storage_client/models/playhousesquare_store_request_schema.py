...
class PlayhousesquareStoreRequestSchema(BaseModel):
    """
    ...
    update: Optional[PlayhousesquareUpdateSeatStoreSchema] = None
    seats: List[PlayhousesquareStoreSchema]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayhousesquareStoreRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayhousesquareStoreRequestSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "update": PlayhousesquareUpdateSeatStoreSchema.from_dict(obj["update"]) if obj.get("update") is not None else None,
            "seats": [PlayhousesquareStoreSchema.from_dict(_item) for _item in obj["seats"]] if obj.get("seats") is not None else None
        })
        return _obj
