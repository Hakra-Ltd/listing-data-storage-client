...
class MilbPriceStoreSchema(BaseModel):
    """
    ...
    update_items: Optional[List[MilbUpdateItemSchema]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MilbPriceStoreSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MilbPriceStoreSchema from a dict"""
        if obj is None:
            return None
