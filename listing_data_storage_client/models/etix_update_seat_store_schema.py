...
class EtixUpdateSeatStoreSchema(BaseModel):
    """
    EtixUpdateSeatStoreSchema
    """ # noqa: E501
    add_place: List[EtixPriceStoreSchema] = Field(alias="addPlace")
    remove_place: List[StrictStr] = Field(alias="removePlace")
    update_place: List[EtixPriceStoreSchema] = Field(alias="updatePlace")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EtixUpdateSeatStoreSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EtixUpdateSeatStoreSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "addPlace": [EtixPriceStoreSchema.from_dict(_item) for _item in obj["addPlace"]] if obj.get("addPlace") is not None else None,
            "removePlace": obj.get("removePlace"),
            "updatePlace": [EtixPriceStoreSchema.from_dict(_item) for _item in obj["updatePlace"]] if obj.get("updatePlace") is not None else None,
