...
class MlbPriceStoreSchema(BaseModel):
    """
    MlbPriceStoreSchema
    """ # noqa: E501
    place_id: StrictStr
    ...
    update_items: Optional[List[MlbUpdateItemSchema]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MlbPriceStoreSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MlbPriceStoreSchema from a dict"""
        if obj is None:
            return None
