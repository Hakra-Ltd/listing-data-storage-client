...
class EtixStoreSchema(BaseModel):
    """
    EtixStoreSchema
    """ # noqa: E501
    place_id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["place_id", "section", "row", "seat", "row_rank", "seat_rank", "price_level_id", "price_code_name", "max_quantity", "total_price"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EtixStoreSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EtixStoreSchema from a dict"""
        if obj is None:
            return None
