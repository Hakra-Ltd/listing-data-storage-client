...
class SeatViewResponseSchema(BaseModel):
    """
    Seat view response schema.
    """ # noqa: E501
    timestamp: Optional[datetime] = None
    seats: List[SeatStoreSchema]
    __properties: ClassVar[List[str]] = ["timestamp", "seats"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SeatViewResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SeatViewResponseSchema from a dict"""
        if obj is None:
            return None
