...
class OvationtixStoreRequestSchema(BaseModel):
    """
    ...
    update: Optional[OvationtixUpdateSeatStoreSchema] = None
    seats: List[OvationtixStoreSchema]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OvationtixStoreRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OvationtixStoreRequestSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "update": OvationtixUpdateSeatStoreSchema.from_dict(obj["update"]) if obj.get("update") is not None else None,
            "seats": [OvationtixStoreSchema.from_dict(_item) for _item in obj["seats"]] if obj.get("seats") is not None else None
        })
        return _obj
