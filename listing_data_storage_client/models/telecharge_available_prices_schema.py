...
class TelechargeAvailablePricesSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["place_id", "total_price", "base_price", "fees", "section_code", "seat_status", "section", "row", "row_rank", "seat_number", "seat_index", "attributes", "description"]
