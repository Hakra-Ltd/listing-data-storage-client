...
class MilbStoreSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["place_id", "seat_position_index", "seat_number", "section_id", "section", "row_rank", "row", "price", "total_price", "service_charge", "attributes", "description"]
