...
class MilbStoreSchema(BaseModel):
    """
    MilbStoreSchema
    """ # noqa: E501
    place_id: StrictStr
    ...
    total_price: Optional[TotalPrice1] = None
    service_charge: Optional[ServiceCharge] = None
    attributes: Optional[StrictStr] = None
    offer_name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["place_id", "seat_position_index", "seat_number", "section_id", "section", "row_rank", "row", "price", "total_price", "service_charge", "attributes", "offer_name", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MilbStoreSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MilbStoreSchema from a dict"""
        if obj is None:
            return None
